...
import controller.WhatIfViewController;
...
{
	private WhatIfViewController		controller;						// Controller
										
	private HBox						majorChoicePane;
	private Label						majorChoiceLabel;
	private ComboBox					majorComboBox;
	private Button						majorChoiceButton;
	private Line						line6;
	...
	// Constructor
	public WhatIfView(Stage stage, WhatIfViewController controller)
	{
		...
		majorChoiceLabel = new Label("Desired Major:");
		majorChoiceLabel.setStyle("-fx-font-weight: bold");
		majorComboBox = new ComboBox();
		majorChoiceButton = new Button("Generate New Analysis");
		majorChoiceButton.setOnAction(e ->
		{
		
		});
		
		majorChoicePane = new HBox(40);
		
		majorChoicePane.getChildren().addAll(majorChoiceLabel, majorComboBox, majorChoiceButton);
		
		line6 = new Line(100, 40, 1700, 40);
		
		topPane = new VBox(10);
		topPane.getChildren().addAll(majorChoicePane, line6);
		...
		programResultLabel = new Label(controller.getStudentModel().getMajor().getTitle());
		...
		majorResultLabel = new Label(controller.getStudentModel().getMajor().getTitle());
		...
		endPane.getChildren().addAll(keyLabel, line5, endNotesLabel);
		...
		pane.getChildren().addAll(topPane, studentPane, coursesPane, majorPane, endPane);
